"use strict";
(self["webpackChunktodo_list_app"] = self["webpackChunktodo_list_app"] || []).push([["render"],{
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/compareDesc/index.js");
...
const _renderTodayTasks = () => {
    ...
    todayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(todayDate, 'dd-MM-yyyy');
    const taskArray = ['Today',];
    for (let i = 0; i < _master_structure_js__WEBPACK_IMPORTED_MODULE_0__.masterArray.length; i++) {
        for (let j = 1; j < _master_structure_js__WEBPACK_IMPORTED_MODULE_0__.masterArray[i].length; j++) {
            if (_master_structure_js__WEBPACK_IMPORTED_MODULE_0__.masterArray[i][j]['dueDate'] === todayDate) taskArray.push(_master_structure_js__WEBPACK_IMPORTED_MODULE_0__.masterArray[i][j])
        }
    };
    return taskArray;
};
...
const _renderSevenDayTasks = () => {
    let todayDate = generateCurrentDate();
    let seventhDay = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(todayDate, {
        days: 7,
    });
    ...
    for (let i = 0; i < _master_structure_js__WEBPACK_IMPORTED_MODULE_0__.masterArray.length; i++) {
        for (let j = 1; j < _master_structure_js__WEBPACK_IMPORTED_MODULE_0__.masterArray[i].length; j++) {
            let storedDate = _master_structure_js__WEBPACK_IMPORTED_MODULE_0__.masterArray[i][j]['dueDate'];
            arr.length = 0;
            arr.push(...storedDate.split('-'));
            let formattedText = arr[2] + '-' + arr[1] + '-' + arr[0];
            let parsedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(formattedText);
            if (
                (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(parsedDate, seventhDay) === 1
                ||
                (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(parsedDate, seventhDay) === 0
            ) taskArray.push(_master_structure_js__WEBPACK_IMPORTED_MODULE_0__.masterArray[i][j])
        }
    };
    return taskArray;
};
...
const _renderImportant = () => {
    ...
    for (let i = 0; i < _master_structure_js__WEBPACK_IMPORTED_MODULE_0__.masterArray.length; i++) {
        for (let j = 1; j < _master_structure_js__WEBPACK_IMPORTED_MODULE_0__.masterArray[i].length; j++) {
            if (_master_structure_js__WEBPACK_IMPORTED_MODULE_0__.masterArray[i][j]['priority'] === 'h') taskArray.push(_master_structure_js__WEBPACK_IMPORTED_MODULE_0__.masterArray[i][j])
        }
    };
    return taskArray;
};
...
const display = (event) => {
    ...
    switch (className) {
        case 'today':
            (0,_task_js__WEBPACK_IMPORTED_MODULE_1__["default"])(_renderTodayTasks());
            break;

        case 'seven-days':
            (0,_task_js__WEBPACK_IMPORTED_MODULE_1__["default"])(_renderSevenDayTasks());
            break;

        case 'important':
            (0,_task_js__WEBPACK_IMPORTED_MODULE_1__["default"])(_renderImportant());
            break;
