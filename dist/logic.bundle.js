    ...
    const _formSubmission = (className) => {
        switch (className) {
            ...
            case 'project-pop-up':
                ...
                (0,_storage_js__WEBPACK_IMPORTED_MODULE_4__["default"])();
            ...
            case 'task-form':
                ...
                const newTask = {
                    ...
                    dueDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(collection[3].querySelector(':nth-child(2)').value), 'dd-MM-yyyy'),
